...
ARjs.MarkerControls = THREEx.ArMarkerControls = function (
    context,
    object3d,
    parameters
) {
 ...
 */
ARjs.MarkerControls.prototype.updateWithModelViewMatrix = function (
    modelViewMatrix
) {
    ...
    if (this.parameters.changeMatrixMode === "modelViewMatrix") {
        if (this.parameters.smooth) {
            ...
            if (this.smoothMatrices.length < this.parameters.smoothCount + 1) {
                ...
                if (
                    exceedsAverageTolerance >= this.parameters.smoothThreshold
                ) {
...
ARjs.MarkerControls.prototype.name = function () {
    ...
    if (this.parameters.type === "pattern") {
        ...
        console.assert(
            false,
            "no .name() implemented for this marker controls"
        );
    }
    return name;
};
