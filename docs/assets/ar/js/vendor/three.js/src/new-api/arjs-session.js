...
ARjs.Session = function (parameters) {
    ...
    function setParameters(parameters) {
        ...
        for (var key in parameters) {
            ...
            if (newValue === undefined) {
                console.warn(
                    "THREEx.Session: '" + key + "' parameter is undefined."
                );
                continue;
            }
    ...
    //		init arSource
    //////////////////////////////////////////////////////////////////////////////
    var arSource = (_this.arSource = new ARjs.Source(
    ...
    var arContext = (_this.arContext = new ARjs.Context(
